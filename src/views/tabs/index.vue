    ...
    <div class="top_bar">
      <div class="left_bar" @click="toIdentity">
        <template v-if="!isLogin">
          请登录 <img src="@img/index/sanjiao@2x.png" alt="">
        </template>
        <template v-else-if="isSelectIdentity">
          {{grades[identity.userGrade].grade}}（{{identitys[identity.userIdentities].identity}}） <img src="@img/index/sanjiao@2x.png" alt="">
        </template>
        <template v-else>
          请选择 <img src="@img/index/sanjiao@2x.png" alt="">
        </template>
      </div>
      <div class="right_bar">
